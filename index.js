...
module.exports = exports = function YouTube (opts) {
	// TODO
	// opts has config options like API keys
	// TODO comment doc above
	// TODO this._opts

	this._opts = {};
	this._opts.batchDelay = opts.batchDelay || 50;
	this._opts.batchLimit = opts.batchLimit || 50;
	this._opts.apiKey = opts.apiKey || ''; // ...or what? What's a sensible default? Maybe we error?
}
...
YouTube.prototype.getLength = _timeBatch(this._opts.batchDelay, this._opts.batchLimit, function (reqs) {
	var ids = _groupCalls(reqs);
	this._listVideos(ids, 'contentDetails', function (item) {
...
YouTube.prototype.getDetails = _timeBatch(this._opts.batchDelay, this._opts.batchLimit, function (reqs) {
	var ids = _groupCalls(reqs);
	this._listVideos(ids, 'snippet', function (item) {
